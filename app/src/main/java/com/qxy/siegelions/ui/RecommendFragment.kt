...
import com.qxy.siegelions.ui.VideoAdapter
...
//        subscribe.unsubscribe()
    ...
    private fun playCurVideo(position: Int) {
        ...
        //切换播放视频的作者主页数据
        RxBus.getDefault().post(CurUser(DataCreate.datas[position].user!!))
        curPlayPos = position
    ...
    private fun autoPlayVideo(position: Int, ivCover: ImageView) {
        val bgVideoPath = "android.resource://" + requireActivity().packageName + "/" + DataCreate.datas[position].videoRes
